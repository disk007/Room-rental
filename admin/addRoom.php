            ...
            <div class="bg-light bg-light shadow-lg bg-body-tertiary">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="addRoom.php">
                        ...
                        <span class="text-primary">เพิ่มห้องพัก</span></a>
                </li>
            </div>
            <div>
                <hr class="sidebar-divider ">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="card shadow mb-4 d-flex justify-content-center">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">เพิ่มห้องพัก</h6>
                        </div>



                        <div class="card-body ">
                            <form action="./php/processAdd.php" method="post" class="needs-validation" id="form" enctype="multipart/form-data" novalidate>
                                <div class="form-group mb-4 input-control">
                                    <label for="nameRoom">ชื่อห้องพัก</label>
                                    <input type="text" class="form-control " id="nameRoom" name="nameRoom" placeholder="กรอกชื่อ" style="margin:auto;" required>
                                    ...
                                    <div class="form-row">
                                        <div class="col mb-2 input-control">
                                            ...
                                            <select class="custom-select" name="typeRoom" id="typeRoom" required >
                                                <option value="" disabled selected>ประเภทห้องพัก</option>
                                                <option value="ari">ห้องแอร์</option>
                                        ...
                                        <div class="col mb-2 input-control">
                                            ...
                                            <select class="custom-select" name="typeBed" id="typebed" required>
                                                ...
                                                <option value="3">เตียงรวม</option>
                                ...
                                <div class="form-group ">
                                    <div class="form-row d-flex justify-content-center">
                                        <div class="col-md-6 mb-3 mr-3 input-control">
                                            ...
                                            <input type="number" class="form-control " name="price" id="price" aria-describedby="emailHelp" placeholder="กรอกราคา" required>
                                            <span class="error1"></span>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row input-control">
                                        <div class="col mb-2 mx-1 mr-1">
                                            <input type="file" id="img"  class="form-control  custom-file-input" name="img" accept="image/*" style="cursor: pointer;" required>
                                ...
                                <div class="form-group">
                                    <div class="form-row input-control">
                                        <div class="col mb-2 mx-1 mr-1">
                                            <input type="file" id="imgDetail" class="form-control  custom-file-input" name="imgDetail[]" accept="image/*" multiple style="cursor: pointer;" required>
                                ...
                                <button type="submit" class="btn btn-primary btn-block" name="add" id="add" disabled>เพิ่มห้องพัก</button>
                            </form>
