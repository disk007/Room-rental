...
<head>
    ...
    <script defer src="./js/addRoom.js"></script>
</head>
            ...
            <div id="content">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="./php/processAdd.php" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                <div class="form-group mb-4 input-control">
                                    <label for="nameRoom">ชื่อห้องพัก</label>
                                    <input type="text" class="form-control bg-white" id="nameRoom" name="nameRoom" style="width: 500px;" value="<?php echo $value['nameRoom']; ?>" disabled>
                                </div>
                                <div class="form-group ">
                                    <div class="form-row">
                                        <div class="col mb-2 input-control">
                                            <label for="typeRoom">ประเภทห้องพัก</label>
                                            <select class="custom-select" name="typeRoom" id="typeRoom">
                                                <option value="" disabled selected><?php echo $value['typeRoom']; ?></option>
                                            </select>
                                        </div>
                                        <div class="col mb-2 input-control">
                                            <label for="typebed">ประเภทเตียง</label>
                                            <select class="custom-select" name="typeBed" id="typebed" required>
                                                <option value="" disabled selected><?php echo $value['typeBed']; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="form-row d-flex justify-content-center">
                                        <div class="col-md-6 mb-3 mr-3 input-control">
                                            ...
                                            <input type="number" class="form-control bg-white" name="price" id="price" aria-describedby="emailHelp" value="<?php echo $value['price']; ?>" disabled>
                                        </div>
                                        <?php
                                        if ($value['parking'] == 1) {     ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="car" name="car" checked disabled>
                                                <label class="form-check-label" for="inlineCheckbox1" style="color: #646F73;">ที่จอดรถ</label>
                                            </div>
                                        <?php } else {
                                        ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="car" name="car" disabled>
                                                <label class="form-check-label" for="inlineCheckbox1" style="color: #646F73;">ที่จอดรถ</label>
                                            </div>
                                        <?php }
                                        if (($value['wifi'] == 1)) {
                                        ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="wifi" name="wifi" checked disabled>
                                                <label class="form-check-label" for="inlineCheckbox2" style="color: #646F73;">WIFI</label>
                                            </div>
                                        <?php } else {
                                        ?>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="wifi" name="wifi" disabled>
                                                <label class="form-check-label" for="inlineCheckbox2" style="color: #646F73;">WIFI</label>
                                            </div>
                                        <?php } ?>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control bg-white" id="detail" name="detail" rows="5" disabled><?php echo $value['detail']; ?></textarea>
                                </div>
                                <!-- <button type="submit" class="btn btn-primary btn-block" name="add">เพิ่มห้องพัก</button> -->
                            </form>
